...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.controller = undefined;\n\nvar _viewController = __webpack_require__(/*! ./viewController */ \"./src/controllers/viewController.js\");\n\nvar controller = exports.controller = function (viewCtrl) {\n\n    var setUpListeners = function setUpListeners() {\n        document.querySelector(viewCtrl.DOM().menu).addEventListener('click', function (e) {\n\n            if (e.target.className === 'e') {\n                var element = [e.target.id, e.target.innerText];\n\n                viewCtrl.click(element);\n            }\n        });\n    };\n\n    return {\n        init: function init() {\n            console.log('Application has started..');\n\n            //Add Menu\n            viewCtrl.addMenu();\n            setUpListeners();\n        }\n    };\n}(_viewController.viewController);\n\n/** Tasks\n * 1. Add Cards\n * \n * \n * \n * \n * \n */\n\n//# sourceURL=webpack:///./src/controllers/mainController.js?");
...
"use strict";
eval("\n\nvar _mainController = __webpack_require__(/*! ./controllers/mainController */ \"./src/controllers/mainController.js\");\n\n_mainController.controller.init();\n\n//# sourceURL=webpack:///./src/index.js?");
